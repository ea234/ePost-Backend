...
public class KundeList implements ServiceListKunde {
  ...
  private void doDummyKundenErstellung()
  {
...
//
//    Kunde bestands_kunde = getKundeByStammnummer( stammNr );
//
//    if ( bestands_kunde == null )
//    {
...
//
//      kundeRepository.save( new_kunde );
//
//      add( new_kunde );
//    }
//  }
...
//  /*
//   * ****************************************************************************
//   * Alte Funktion fuer die Erstellung von Testdaten
//   * ****************************************************************************
//   */
////  public void doTestDatenVersion1()
////  {
////    log.info( "🔴doTestDatenVersion1 Kunde" );
////
////    Faker faker = new Faker( new Locale( "de" ) );
////
////    for ( int nr = 0; nr < 22; nr ++ )
////    {
////      String stamm_nummer = "17000" + nr;
////
////      String kunde_vorname = faker.name().firstName();
////      String kunde_nachname = faker.name().lastName();
////      String kunde_email = kunde_vorname + "." + kunde_nachname + "@web.de";
////      String kunde_telefon_handy = faker.phoneNumber().cellPhone();
////      String kunde_geb_datum_string = faker.date().birthday( 24, 70, "yyyyMMdd" );
...
////
////      String vabschluss = faker.date().birthday( 5, 15, "yyyyMMdd" );
////
////      int alter_vab = FkDatum.getAnzahlJahre( kunde_geb_datum_date, date_today );
////
////      Kunde new_kunde = new Kunde();
////
...
////
////      String adresse_strasse = faker.address().streetAddress();
////      String adresse_ort = faker.address().city();
////      String adresse_plz = faker.address().zipCode();
...
////
////      v1.setBezeichnung( "Vertrag 1" );
////      v1.setDatumAbschluss( FkDatum.getDate() );
////      v1.setDatumEnde( FkDatum.getDate() );
////      v1.setStammNummer( stamm_nummer );
////      v1.setVertragsNummer( stamm_nummer + "01" );
////
////      new_kunde.addVertrag( v1 );
////
////      Vertrag v2 = new Vertrag();
////
////      v2.setBezeichnung( "Vertrag 2" );
////      v2.setDatumAbschluss( FkDatum.getDate() );
////      v2.setDatumEnde( FkDatum.getDate() );
////      v2.setStammNummer( stamm_nummer );
////      v2.setVertragsNummer( stamm_nummer + "02" );
////      v2.setKunde( new_kunde );
////
////      new_kunde.addVertrag( v2 );
////
////      log.info( "🔴KundeList - doTestDaten() save " + new_kunde.toString() );
////
////      kundeRepository.save( new_kunde );
////
////      add( new_kunde );
